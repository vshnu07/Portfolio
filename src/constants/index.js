...
const projects = [
  // Sorted newest → oldest
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Feb 2026", color: "green-text-gradient" }],
    image: cert_nodejs,
  ...
  },
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Nov 2025", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "Oracle", color: "blue-text-gradient" }, { name: "Oct 2025", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Oct 2025", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "Cipher Schools", color: "pink-text-gradient" }, { name: "Jul 2025", color: "green-text-gradient" }],
    image: cert_ml_guide,
  ...
  },
  {
    ...
    tags: [{ name: "LPU", color: "blue-text-gradient" }, { name: "May 2025", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Dec 2024", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "LPU", color: "blue-text-gradient" }, { name: "Dec 2024", color: "green-text-gradient" }],
    image: cert_dsa_lpu,
    hosted_link: "#",
  },
  {
  ...
  },
  {
    ...
    tags: [{ name: "Google", color: "blue-text-gradient" }, { name: "Sep 2024", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Sep 2024", color: "green-text-gradient" }],
  ...
  },
  {
    ...
    tags: [{ name: "NxtWave", color: "blue-text-gradient" }, { name: "Aug 2024", color: "green-text-gradient" }],
